    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__stocks__E68284D33119D959", x => new { x.store_id, x.product_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__order_it__837942D4AFFB21C5", x => new { x.order_id, x.item_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__staffs__AB6E6164CFCB8C80",
                schema: "sales",
                table: "staffs",
                column: "email",
                unique: true);
